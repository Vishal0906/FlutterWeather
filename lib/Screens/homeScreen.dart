  ...
  class _CustomSearchBarState extends State<CustomSearchBar> {
    List<String> _citiesSuggestion = [
      'Delhi', 'Mumbai', 'Kolkata', 'Chennai', 'Bengaluru', 'Hyderabad', 'Ahmedabad', 'Pune', 'Jaipur', 'Lucknow', 'Varanasi', 'Bhopal', 'Chandigarh', 'Surat', 'Patna', 'Indore', 'Kochi', 'Guwahati', 'Bhubaneswar', 'Amritsar', 'Shimla', 'Dehradun', 'Srinagar', 'Jammu', 'Nagpur', 'Thiruvananthapuram', 'Ranchi', 'Raipur', 'Agra', 'Prayagraj', 'Vadodara', 'Mysuru', 'Udaipur', 'Jodhpur', 'Madurai', 'Aurangabad', 'Noida', 'Gurugram', 'Coimbatore', 'Kanpur', 'Gwalior', 'Tirupati', 'Panaji', 'Shillong', 'Imphal', 'Aizawl', 'Itanagar', 'Gangtok', 'Siliguri', 'Warangal', 'Rishikesh', 'Haridwar', 'Kanyakumari', 'Nashik', 'Aligarh', 'Meerut', 'Ayodhya'
    ];
